        ...
        <div class="flex flex-col items-center mt-10  mx-auto md:h-screen lg:py-0">
            <div
                ...
                <div class="p-3 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="{{route('update.product',$product->id)}}" method="POST"
                        ...
                        <div class="mb-6">
                            ...
                            <select name="category" id="category"
                                ...
                                <option value="{{$product->category_id}}" selected>{{$category->category}}
                                </option>
                                @else
                        ...
                        <div class="mb-6">
                            ...
                            <select name="subcategory" id="subcategory"
                                ...
                                <option value="{{$product->subcategory_id}}" selected>{{$subcategory->subcategory}}
                                </option>
                                @else
