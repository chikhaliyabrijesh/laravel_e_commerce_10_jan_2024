                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img style="width:90px; height:100px;"
                                src="{{asset('storage/product_images/'.$product->image)}}" alt=""></td>
                        <td>{{$product->categories->category}}</td>
                        <td>{{$product->subcategories->subcategory}}</td>
                        <td>{{$product->product_name}}</td>
                        <td>{{$product->price}}</td>
                        <td>
                            <a href="{{route('edit.product',$product->id)}}"><button type="button"
                            ...
                            <a href="{{route('delete.product',$product->id)}}"><button type="button"
