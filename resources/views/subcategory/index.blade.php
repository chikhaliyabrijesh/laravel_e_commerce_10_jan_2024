<x-app-layout>
    ...
    <div class="container mx-auto px-32 mt-10">
        <div class="w-full">
            ...
            @endif
            <a href="{{route('create.subcategory')}}"><button type="button"
            ...
            <table id="example" class="display w-full p-5">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('edit.subcategory',$subcategory->id)}}"><button type="button"
                            ...
                            <a href="{{route('delete.subcategory',$subcategory->id)}}"><button type="button"
